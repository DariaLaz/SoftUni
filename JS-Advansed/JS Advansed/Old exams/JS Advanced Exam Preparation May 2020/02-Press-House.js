function pressHouse(){
    ...
    class ShortReports extends Article{
        constructor(title, content, originalResearch){
            ...
            } else if(!Object.keys(originalResearch).includes('title') || !Object.keys(originalResearch).includes('author')){
    ...
    class BookReview extends Article{
        ...
        addClient(clientName,  orderDescription){
            if(this.clients.some(x => x.clientName == clientName && x.orderDescription == orderDescription)){
